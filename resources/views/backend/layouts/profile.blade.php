												...
												<div class="col-lg-12 col-md-12 col-xl-6">
													<div class="d-flex flex-wrap align-items-center">
														<div class="profile-img-main rounded">
															<img src="{{asset('dashboard/assets/images/faces/6.jpg' ) } }" alt="img" class="m-0 p-1 rounded hrem-6">
														</div>
														<div class="ms-4">
															<h4>Elena Gilbert</h4>
									...
									<div class="tab-content">
												...
												<div class="col-12">
													<div class="card border">
														<div class="card-header border-bottom d-block p-4">
															<div class="media overflow-visible">
																<div class="media-user me-2">
																	<div class="main-img-user"><img alt="" class="rounded-circle avatar-md" src="{{asset('dashboard/assets/images/faces/6.jpg' ) } }"></div>
																</div>
																<div class="media-body">
														...
														<div class="card-body">
															...
															<div class="row row-sm">
																<div class="col">
																<img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{asset('dashboard/assets/images/media/timeline1.jpg' ) } }">
																<img alt="img" class="h-200 br-5" src="{{asset('dashboard/assets/images/media/timeline2.jpg' ) } }">
																</div>
															</div>
															<div class="media mt-4 profile-footer align-items-center">
																<div class="avatar-list avatar-list-stacked me-4">
																	<span class="avatar avatar-md rounded-circle bradius cover-image" data-bs-image-src= "{{asset('dashboard/assets/images/users/8.jpg' ) } }"></span>
																	<span class="avatar avatar-md rounded-circle bradius cover-image" data-bs-image-src= "{{asset('dashboard/assets/images/users/7.jpg' ) } }"></span>
																	<span class="avatar avatar-md rounded-circle bradius cover-image" data-bs-image-src= "{{asset('dashboard/assets/images/users/9.jpg' ) } }"></span>
																	<span class="avatar avatar-md rounded-circle bradius cover-image" data-bs-image-src= "{{asset('dashboard/assets/images/users/14.jpg' ) } }"></span>
																	<span class="avatar avatar-md rounded-circle bradius cover-image" data-bs-image-src= "{{asset('dashboard/assets/images/users/11.jpg' ) } }"></span>
													...
													<div class="card border">
														...
														<div class="card-body">
															...
															<div class="row row-sm">
																<div class="col">
																<img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{asset('dashboard/assets/images/media/timeline3.jpg' ) } }">
																<img alt="img" class="h-200 br-5" src="{{asset('dashboard/assets/images/media/timeline4.jpg' ) } }">
																</div>
															</div>
															<div class="media mt-4 profile-footer align-items-center">
																<div class="avatar-list avatar-list-stacked me-4">
													...
													<div class="card border">
														...
														<div class="card-body">
															...
															<div class="row row-sm">
																<div class="col">
																<img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{asset('dashboard/assets/images/media/timeline5.jpg' ) } }">
																<img alt="img" class="h-200 br-5" src="{{asset('dashboard/assets/images/media/timeline6.jpg' ) } }">
																</div>
															</div>
															<div class="media mt-4 profile-footer align-items-center">
																<div class="avatar-list avatar-list-stacked me-4">
													...
													<div class="card">
														...
														<div class="card-body">
															...
															<div class="row row-sm">
																<div class="col">
																<img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{asset('dashboard/assets/images/media/timeline7.jpg' ) } }">
																<img alt="img" class="h-200 br-5" src="{{asset('dashboard/assets/images/media/timeline9.jpg' ) } }">
																</div>
															</div>
															<div class="media mt-4 profile-footer align-items-center">
																<div class="avatar-list avatar-list-stacked me-4">
										...
										<div class="tab-pane" id="gallery">
											<div class="row  mb-5 img-gallery" id="lightgallery">
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/8.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/8.jpg' ) } }">
												<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/8.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/10.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/10.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/10.jpg' ) } }" alt="banner image "></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/11.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/11.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/11.jpg' ) } }" alt="banner image "></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/12.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/12.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/12.jpg' ) } }" alt="banner image "></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/13.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/13.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/13.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/14.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/14.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/14.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/15.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/15.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/15.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/16.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/16.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/16.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/17.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/17.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/17.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/18.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/18.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/18.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/19.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/19.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('dashboard/assets/images/media/19.jpg' ) } }" alt="banner image"></a>
												</div>
												<div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('dashboard/assets/images/media/20.jpg' ) } }" data-src="{{asset('dashboard/assets/images/media/20.jpg' ) } }">
													<a href="#"><img class="img-fluid wp-100 br-5" src="{{asset('dashboard/assets/images/media/20.jpg' ) } }" alt="banner image"></a>
												</div>
											</div>
										</div>
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/1.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/11.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/12.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/5.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/7.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/13.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/8.jpg' ) } }">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="#">
																<img alt="avatar" class="avatar avatar-xl rounded" src="{{asset('dashboard/assets/images/faces/4.jpg' ) } }">
